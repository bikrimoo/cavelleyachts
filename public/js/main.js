...
(function(){
  ...
  if(fc){
    ...
    fcToggle.addEventListener('click', function(){
      ...
      fcToggle.setAttribute('aria-expanded', fc.classList.contains('open'));
    });
  ...
  document.querySelectorAll('.tabs').forEach(function(tabGroup){
    ...
    var panels = targetSel ? document.querySelectorAll(targetSel + ' [data-tab-panel]') : [];
    buttons.forEach(function(btn){
      btn.addEventListener('click', function(){
        ...
        panels.forEach(function(p){
          p.style.display = (p.getAttribute('data-tab-panel') === val || val === 'all') ? '' : 'none';
        });
      });
    });
  });
